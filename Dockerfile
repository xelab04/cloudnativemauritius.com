FROM docker.io/dunglas/frankenphp:1.9-builder-php8.4-alpine AS setup

RUN install-php-extensions pcntl pdo_mysql redis xdebug bcmath sockets intl gd imagick exif gmp soap zip bz2 calendar
